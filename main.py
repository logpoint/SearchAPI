...
def allowed_repos_from_logpoints():
  logpoints = searcher.get_log_points()
  if isinstance(logpoints, Error):
     print 'Error : ', logpoints.get_error_message()
...
def allowed_devices_from_logpoints():
  logpoints = searcher.get_log_points()
  if isinstance(logpoints, Error):
     print 'Error : ', logpoints.get_error_message()
...
def get_queries_from_logpoints():
  logpoints = searcher.get_log_points()
  if isinstance(logpoints, Error):
     print 'Error : ', logpoints.get_error_message()
...
def main():
  # get_logopints()
  # allowed_repos()
  # allowed_repos_from_logpoints()
  # allowed_devices()
  # allowed_devices_from_logpoints()
  # get_timezone()  
  # get_queries()
  # get_queries_from_logpoints()
  get_livesearches()
